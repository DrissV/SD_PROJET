...
public class Doodle {
	...
	// ajoute les disponibilités d'un participant sous forme d'un tableau de
	// booleen.
	// les indices du tableau correspondent aux indices du tableau plages
	// true à l'indice i veut dire que le participant est disponible pour la plage à
	// l'indice i du tableau plages
	// false à l'indice i veut dire que le participant n'est pas disponible pour la
	// plage à l'indice i du tableau plages
	...
	// Hypothèse: la PlageHoraire plage en paramètre fait bien partie du tableau
	// plages
	...
	// cette méthode est appelée après que les participants aient rempli leurs
	// disponibilités
