...
public class Test {
	...
	public static void main(String[] args) {
		PlageHoraire p1 = new PlageHoraire(LocalDateTime.of(2017, 10, 5, 16, 0, 0),
				LocalDateTime.of(2017, 10, 5, 17, 0, 0));
		PlageHoraire p2 = new PlageHoraire(LocalDateTime.of(2017, 10, 12, 14, 0, 0),
				LocalDateTime.of(2017, 10, 12, 15, 0, 0));
		PlageHoraire p3 = new PlageHoraire(LocalDateTime.of(2017, 10, 19, 12, 0, 0),
				LocalDateTime.of(2017, 10, 19, 13, 0, 0));
